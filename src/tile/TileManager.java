...
public class TileManager {
    ...
    public void getTileImage() {
        ...
        try {
            ...
            tile[2] = new Tile();
            tile[2].image = javax.imageio.ImageIO.read(getClass().getResourceAsStream("/tiles/water.png"));
    ...
    public void draw(Graphics2D g2) {
        ...
        while (worldCol < gp.maxWorldCol && worldRow < gp.maxWorldRow) {
            ...
            if (worldX + gp.tileSize > gp.player.worldX - gp.player.screenX &&
                    worldX - gp.tileSize < gp.player.worldX + gp.player.screenX + gp.player.screenX &&
                    worldY + gp.tileSize > gp.player.worldY - gp.player.screenY &&
                    worldY - gp.tileSize < gp.player.worldY + gp.player.screenY + gp.player.screenY) {
